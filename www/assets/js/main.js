  ...
  return {
    ...
    init: function (options) {
      ...
      //Prevent Connections Dropdown closes on click      
        ...
        $("#customers_menu li:nth-child(1)").click(function()
        {
            window.location = "/admin/customer/configurations";
            // $("#configurations").submit();
        });
        $(".btn.btn-default.btn-show-all").click(function()
        {
            window.location = "/admin/customer/configurations";
            // $("#configurations").submit();
        });

        $("#customers_menu li:nth-child(2)").click(function()
        {
            window.location = "/admin/customer/bycustomer";
            // $("#bycustomer").submit();
        });
                
        $("#user_company_menu li:nth-child(1)").click(function()
        {
            window.location = "/admin/user/list";
            // $("#users").submit();
        });

        $("#user_company_menu li:nth-child(2)").click(function()
        {
            window.location = "/admin/company/list";
            // $("#companies").submit();
        });

        $("#user_company_menu li:nth-child(3)").click(function()
        {
            window.location = "/admin/user/add";
            // $("#add").submit();
        });

        $("#modules_menu li:nth-child(1)").click(function()
        {
            window.location = "/admin/module/module";
            // $("#beautyconfigurator").submit();
        });

        $("#product_menu li:nth-child(1)").click(function()
        {
            window.location = "/admin/product/brandlist";
            // $("#beautyconfigurator").submit();
        });

        $(".btn.btn-default.add_user").click(function()
        {
            $("#add").submit();
        });
        
        // $(".btn.btn-default.add_company").click(function()
        // {
        //     $("#addCompany").submit();
        // });        

        $(".btn.btn-default.upload_picture").click(function()
        {
            uploadMemberPhoto();
        });
        ...
        $(".be-right-navbar .dropdown-menu li:nth-child(4)").click(function()
        {
            // $("#logout").submit();
            window.location = "/user/index/logout";
        });
...
function loadProfile(cname, uid) 
{
  window.location.href = "/admin/customer/customerProfile?customer="+cname+"&userid="+uid;
};

function loadBeauty(cid, cname, uid) 
{
  window.location.href = "/admin/customer/beautyConfiguration?client_id="+cid+"&customer="+cname+"&userid="+uid; 
...
{
  $("#user_search_status").val(0);
  $("#new_user_form").submit();
}

function loadConfiqureBeauty()
{
  window.location.href = "/admin/module/configureBeauty";
}
function loadSelektieren()
{
  window.location.href = "/admin/module/configureSelektieren";
}
...
function uploadMemberPhoto() 
{
  ...
  chooser.addEventListener("change", function(evt) {
    ...
    xhr.open('POST', '/admin/index/memberphoto');
