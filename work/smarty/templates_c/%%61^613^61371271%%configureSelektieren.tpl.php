<?php /* Smarty version 2.6.18, created on 
         compiled from module/configureSelektieren.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
unset($_smarty_tpl_vars);
 ?>
    ...
    foreach ($_from as $this->_tpl_vars['region_info']):
?>
                <div class="panel panel-default">
                  <form id="region_save" action="/admin/module/saveRegion" method="post">
                  <input type=hidden name="region_id" id="region_id" value=<?php echo $this->_tpl_vars['region_info']['id']; ?>
>
                    ...
                    <div class="col-md-12" style="padding:0px">
                      ...
                      <div class="col-md-1" style="padding:0px;">
                          <h4 class="panel-title" style="padding-left:0px;  font-weight:bold;">
                           <?php echo $this->_tpl_vars['region_info']['region_name']; ?>
                      ...
                      <div class="col-md-9" align="right" style="padding-right:0px; margin-right:0px">
                        <a data-toggle="collapse" href="#collapse<?php echo $this->_tpl_vars['region_info']['id']; ?>
"><img src="/img/down_arrow.svg"></a>    
                      </div>
                    </div>
                  </div>

                  <div id="collapse<?php echo $this->_tpl_vars['region_info']['id']; ?>
" class="panel-collapse collapse">
                    <div class="panel-body">
                      <div class="form-group col-sm-6" style="padding:0px; padding-top:10px">
                        <input name="region_name" required="required" placeholder="Eye Region" class="form-control" style="width:95%" value="<?php echo $this->_tpl_vars['region_info']['region_name']; ?>
">
                      ...
                      <div class="form-group col-sm-6" style="padding-top:10px">
                        ...
                        <div>
                          <img id="upload_image" <?php if (( $this->_tpl_vars['region_info']['region_img'] == "" )): ?> src="/img/upload_image.png"
                          <?php else: ?>
                            src="<?php echo $this->_tpl_vars['region_info']['region_img']; ?>
"
                          <?php endif; ?>
                          >
                          <input name="region_img_path" id="upload_image_path" type="hidden" value="<?php echo $this->_tpl_vars['region_info']['region_img']; ?>
">
                      ...
                      <div class="wish_container">
                        <?php $_from = $this->_tpl_vars['region_info']['wishes']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['region_wish']):
?>
                        <div>
                          ...
                          <div class="form-group col-sm-6" style="padding:0px; padding-top:10px">
                            ...
                            <input name="wish_ids[]" type="hidden" value="<?php echo $this->_tpl_vars['region_wish']['id']; ?>
">
                            <input name="wish_names[]" type="Eye Region" required="required" placeholder="Wish" class="form-control" style="width:95%" value="<?php echo $this->_tpl_vars['region_wish']['wish_name']; ?>
">
                          </div>
                          <div class="form-group col-sm-5" style="padding-top:10px">
                            ...
                            <div>
                              <img id="upload_image" 
                              <?php if (( $this->_tpl_vars['region_wish']['img'] == "" )): ?> 
                                src="/img/upload_image.png"
                              <?php else: ?>
                                src="<?php echo $this->_tpl_vars['region_wish']['img']; ?>
"
                              <?php endif; ?>
                              >
                              <input name="wish_img_paths[]" id="upload_image_path" type="hidden" value="<?php echo $this->_tpl_vars['region_wish']['img']; ?>
">
                              <button class="btn btn-default upload_skelton" type="button">Upload Picture</button>
                          ...
                          <div class="col-sm-12 sub_heading" style="margin-left:40px; margin-right:20px; width:96%" >
                             ...
                             <a data-toggle="collapse" href="#collapse<?php echo $this->_tpl_vars['region_info']['id']; ?>
_<?php echo $this->_tpl_vars['region_wish']['id']; ?>
" class="" aria-expanded="true"><img src="/img/down_arrow.svg"></a>
                          </div>
                          <div id="collapse<?php echo $this->_tpl_vars['region_info']['id']; ?>
_<?php echo $this->_tpl_vars['region_wish']['id']; ?>
" class="panel-collapse collapse" style="margin-left:40px; margin-right:20px; width:96%">
                            <div class="form-group col-sm-12" style="padding:0px; padding-top:0px">
                              ...
                              <textarea cols="80" rows="6" id="editor1" name="wish_info1[]" class="form-control CKEDITOR" style="width:95%"><?php echo $this->_tpl_vars['region_wish']['text1']; ?>
</textarea>
                            </div>
                            <div class="form-group col-sm-12" style="padding:0px; padding-top:0px">
                              <label align="left" style="color:#aaa; font-size:13px; font-weight:bold; padding:0px; margin:0px; ">2. Anatomie</label>
                              <textarea cols="80" rows="6" id="editor2" name="wish_info2[]" class="form-control CKEDITOR" style="width:95%"><?php echo $this->_tpl_vars['region_wish']['text2']; ?>
</textarea>
                            </div>
                            <div class="form-group col-sm-12" style="padding:0px; padding-top:0px">
                              <label align="left" style="color:#aaa; font-size:13px; font-weight:bold; padding:0px; margin:0px; ">3. Behandlung</label>
                              <textarea cols="80" rows="6" id="editor3" name="wish_info3[]" class="form-control CKEDITOR" style="width:95%"><?php echo $this->_tpl_vars['region_wish']['text3']; ?>
</textarea>
                            </div>
                            <div>
                              <img id="upload_image"
                              <?php if (( $this->_tpl_vars['region_wish']['detail_img'] == "" )): ?> 
                                src="/img/upload_image.png"
                              <?php else: ?>
                                src="<?php echo $this->_tpl_vars['region_wish']['detail_img']; ?>
"
                              <?php endif; ?>
                              >
                              <input name="detail_img_paths[]" id="upload_image_path" type="hidden" value="<?php echo $this->_tpl_vars['region_wish']['detail_img']; ?>
">
                              <button class="btn btn-default upload_skelton" type="button">Upload Picture</button>
