<?php /* Smarty version 2.6.18, created on 
         compiled from index/editaccount.tpl */ ?>
<!DOCTYPE html>
                ...
                <form id="edit_account_form" class="ui form" action="/user/index/updateaccount" method="post">
                    <div class="two fields">
                        <div class="eight wide field">
                            ...
                            <div class="field">
                                <input id="user_input" class="input_user" type="text" value="<?php echo $this->_tpl_vars['user_info']['fullname']; ?>
">
                            </div>
                        </div>
                        ...
                        <div class="eight wide field">
                            ...
                            <div class="field">
                                <input name="address_input" id="address_input" class="input_user" type="text" value="<?php echo $this->_tpl_vars['user_info']['street']; ?>
">
                            </div>
                        </div>
                    </div>
                    <div class="three fields">
                        <div class="eight wide field">
                            ...
                            <div class="field">
                                <input name="fullname_input" id="fullname_input" class="input_user" type="text" value="<?php echo $this->_tpl_vars['user_info']['fullname']; ?>
">
                            </div>
                        </div>
                        <div class="one wide field">
                        ...
                        <div class="three wide field">
                            <label>PLZ</label>
                            <div class="field">
                                <input name="postal_input" id="postal_input" class="input_user" type="number" value="<?php echo $this->_tpl_vars['user_info']['postal']; ?>
">
                            </div>
                        </div> 
                        <div class="five wide field">
                            <label>ORT</label>
                            <div class="field">
                                <input name="city_input" id="city_input" class="input_user" type="text" value="<?php echo $this->_tpl_vars['user_info']['city']; ?>
">
                            </div>
                        </div>                                                  
                    </div>
                    ...
                    <div class="two fields">
                        <div class="field">
                            ...
                            <div class="field">
                                <input name="email_input" id="email_input" class="input_user" required="required" type="email" value="<?php echo $this->_tpl_vars['user_info']['username']; ?>
">
                            </div>
                        </div>
                        <div class="one wide field">
