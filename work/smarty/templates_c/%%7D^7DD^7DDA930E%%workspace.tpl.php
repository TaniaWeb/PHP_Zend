<?php /* Smarty version 2.6.18, created on 
         compiled from index/workspace.tpl */ ?>
<!DOCTYPE html>
...
<!--                 <div class="ui dropdown item">
        ...
        <div id="workspace_area">
            ...
            <input name="created" id="created" type="hidden" value="<?php echo $this->_tpl_vars['created']; ?>
">
            <form id="update_points" action="/user/index/updatepoints" method="post">
                <input name="clientid" id="clientid" type="hidden" value="<?php echo $this->_tpl_vars['client']['id']; ?>
">
                <input name="points" id="points" type="hidden" value='<?php echo $this->_tpl_vars['client_info']['points']; ?>
'>
                <input name="photourl" id="photourl" type="hidden" value=''>
                <input name="points_count" id="points_count" type="hidden" value=''>
                <input name="emotions_shown" id="emotions_shown" type="hidden" value='<?php echo $this->_tpl_vars['client']['emotions_shown']; ?>
'>
                <input name="mode" id="mode" type="hidden" value="<?php echo $this->_tpl_vars['mode']; ?>
">
                <input name="sub_mode" id="sub_mode" type="hidden" value="<?php echo $this->_tpl_vars['sub_mode']; ?>
">
            </form>
            <div id="canvas_area">
                <canvas id="canvas" src="<?php echo $this->_tpl_vars['client']['image']; ?>
"></canvas>
            </div>
        </div>
        <div id="help_area">
        ...
        <div id="project_summary_area">
            ...
            <div class="ui container">
                <div id="summary_menu_area" class="ui grid">
                    ...
                    <div class="row title">
                        <div class="six wide column">
                            <span class="content"><?php echo $this->_tpl_vars['client']['clientname']; ?>
</span>
                        </div>
                        <div class="five wide column">
                            <span class="content"><?php echo $this->_tpl_vars['client']['age']; ?>
</span>                      
                        </div>
                        <div class="five wide column">
                            <span id="summary_client_gender" class="content"><?php echo $this->_tpl_vars['client']['gender']; ?>
</span>                      
                        </div>
                    </div>
                </div>
        ...
        <div class="ui container">
            ...
            <div class="item" id="right_btn_area">
                ...
                <div id="name" class="header"><?php echo $this->_tpl_vars['client']['clientname']; ?>
</div>
            ...
            <div id="sign_layer_area" class="ui small signlayer modal transition hidden">
                ...
                <div class="content">
                    ...
                    <div class="ui grid">
                        <div class="five wide column">
                            <?php echo $this->_tpl_vars['client']['clientname']; ?>
                ...
                <form id="do_sign" action="/user/index/dosign" method="post">
                    <input name="justcreated" id="justcreated" type="hidden" value="<?php echo $this->_tpl_vars['created']; ?>
">
                    <input name="clientid" id="clientid" type="hidden" value="<?php echo $this->_tpl_vars['client']['id']; ?>
">
                    <input name="signed" id="signed" type="hidden" value="<?php echo $this->_tpl_vars['signed']; ?>
">
            ...
            <div id="confirm_layer_area" class="ui small confirmlayer modal transition hidden">
                ...
                <div class="content">
                    ...
                    <div id="title_label" class="ui center aligned header">
                        Vielen Dank für die
                        Konfiguration, <?php echo $this->_tpl_vars['user_info']['fullname']; ?>

                    </div>
                    <div class="large_avatar">
                        <img class="confirm_client_image" src = "<?php echo $this->_tpl_vars['client']['image']; ?>
"/>
                    </div>
...
">
                        <div class="field height_section">
                            ...
                            <div class="field">
                                <input name="clientname" id="clientname" type="text" required="required" value="<?php echo $this->_tpl_vars['client']['clientname']; ?>
">
                            </div>
                        </div>
                        <div class="two fields height_section">
                            <div class="field">
                                ...
                                <div class="field">
                                    <input name="phone_number" id="phone_number" type="tel" value="<?php echo $this->_tpl_vars['client']['phonenumber']; ?>
">
                                </div>
                            </div>
                            <div class="field">
                                <label>Email</label>
                                <div class="field">
                                    <input name="email" id="clientemail" type="email" required="required" value="<?php echo $this->_tpl_vars['client']['email']; ?>
">
                                </div>
                            </div>                            
                        </div>
                        <div class="field height_section">
                            ...
                            <div class="field">
                                <input name="address" id="address" type="text" value="<?php echo $this->_tpl_vars['client']['address']; ?>
">
                            </div>
                        </div>    
                        <div class="two fields height_section">
                            <div class="field">
                                <label>Alter</label>
                                <div class="field">
                                    <input name="age" id="age" type="number" value="<?php echo $this->_tpl_vars['client']['age']; ?>
">
                                </div>
                            </div>
                            <div class="field">
                                ...
                                <div class="field">
                                    <div class="ui buttons btn_group">
                                        <input name="gender" id="gender" type="hidden" value="<?php echo $this->_tpl_vars['client']['gender']; ?>
">
                        ...
                        <div id="image_list_section" class="field height_section">
                            ...
                            <input name="image_src" id="image_src" type="hidden" value="<?php echo $this->_tpl_vars['client']['image']; ?>
">
