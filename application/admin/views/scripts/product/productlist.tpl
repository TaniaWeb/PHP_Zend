              ...
              <div class="col-md-12" style="padding-bottom: 10px;">
                <div class="col-md-12" style="padding-bottom: 10px; background-color: white; border-radius: 5px; padding-top: 20px; padding-bottom: 20px;">
                  ...
                  <div class="col-md-2" align="right">
                    <div class="btn-group">
                      <button id="btn_edit_user" onclick="editUser(event, '{$user_info.id}')" class="btn btn-default" style="width:70px;">edit</button>
                      <br>
            ...
            <div class="col-md-12" style="margin-bottom: 20px;">
              <div class="col-md-7" style="padding-left: 0px; padding-right: 0px;">
                <div class="col-md-12" style="margin-bottom: 20px; padding-left: 0px; padding-right: 0px;">
                  ...
                  <input name="name" type="text" placeholder="product name" class="form-control" pattern="[0-9]{4}-[0-9]{2}-[0-9]{3}">
                </div>
                <div class="col-md-12" style="margin-bottom: 20px; padding-left: 0px; padding-right: 0px;">
              ...
              <div class="col-md-5" style="padding-left: 20px; padding-right: 0px;">
                ...
                <div>
                  <div class="col-md-7" style="width:144px; height:144px; padding: 10px; border-width: 1px; border-style: dashed; border-color: gainsboro" align="center">
                    <img id="upload_image1" src="{if ($user.avatar==null || $user.avatar=='')}/assets/img/image_product_icon.png{else}{$user.avatar}{/if}" alt="Avatar" height="112px">
                  </div>
                  <div class="col-md-7">
                    <input name="avatar" id="avatar" type="hidden" value="{if ($user.avatar==null || $user.avatar=='')}/assets/img/image_product_icon.png{else}{$user.avatar}{/if}">
