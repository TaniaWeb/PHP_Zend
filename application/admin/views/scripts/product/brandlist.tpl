            ...
            <div class="row">
                ...
                <div class="col-md-4" style="padding-bottom: 15px;">
                  <div class="col-md-12" style="padding-bottom: 10px; background-color: white; border-radius: 5px; padding-top: 20px; padding-bottom: 20px;"  align="center">
                    ...
                    <div class="col-md-12">
                        <button id="btn_edit_user" onclick="editUser(event, '{$user_info.id}')" class="btn btn-default" style="width:45%;">edit Brand</button>
                        <button id="btn_remove_user" onclick="removeUser(event, '{$user_info.id}')" class="btn btn-default" style="width:45%;">Products</button>
                    </div>
                  </div>
                </div>
