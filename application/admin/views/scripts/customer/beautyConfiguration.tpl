...
<html lang="en">
  ...
  <body>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="pull-right">
                  ...
                  <div class="pull-right" style="font-size:23px">{$client_info.date_last_saved}</div>                  
                </div>                
              </div>
            </div>
            <div class="row" style="margin-top:13px">
              <div class="col-md-10">
                <div class="row" >
                  <div class="col-md-3">
                    ...
                    <div style="font-size:15px">{$client_info.phonenumber}</div>    
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <div style="font-size:15px"><img class="gender-img-{$client_info.gender}"> {if ($client_info.gender==0)}female{else}mail{/if}</div>
                  </div>
                </div>
                <div class="row" style="margin-top:13px">
                  <div class="col-md-12">
              ...
              <div class="col-md-2">
                <div class="pull-right">
                  ...
                  <div class="pull-right" >
                    {if ($client_info.signature!="")}
                    <img src="{$client_info.signature}" style="width:120px; height:60px">
                    {/if}
                  </div>                  
                </div>                
              </div>
          ...
          <div class="row">
            <div class="col-md-12" style="padding-left:20px; padding-top:0px">              
              <div class="col-md-6" id="canvas_parent">
                <input  id="clientid" type="hidden" value="{$client_info.id}">
                <input  id="points" type="hidden" value='{$client_info.points}'>
                <input  id="image_url" type="hidden" value='{$client_info.image}'>
                <input  id="points_count" type="hidden" value='{$client_info.points_count}'>
                <input  id="hair_questions" type="hidden" value='{$client_info.hairQuestions}'>
            ...
            <div class="row">
              <div class="col-md-10">
                <div class="profile-item">User Name</div>
                  <div style="font-size:23px"><img src="{$user_info1.avatar}" width="30px" alt="Avatar">     {$user_info1.fullname}</div>
              </div>
              <div class="col-md-2">
                <div class="pull-right">
                  <div class="profile-item">Profile Type</div>
                  <div class="pull-right" style="font-size:23px">
                    {if ($user_info1.account_type==0)}
                      Basic Business
                    {else}
                      Free Account
                    {/if}
            ...
            <div class="row" style="margin-top:13px">
              <div class="col-md-12">
                <div class="row" >
                  <div class="col-md-3">
                    <div class="profile-item">Phone Number</div>
                    <div style="font-size:15px">{$user_info1.phone_country} {$user_info1.phonenumber}</div>    
                  </div>                 
               
                  <div class="col-md-4">
                    <div class="profile-item">Address</div>
                    <div style="font-size:15px">{$user_info1.street}</div>                    
                  </div>
    ...
    <form id="finish_form" action="/admin/customer/tofinish" method="post">
      <input type=hidden name="client_id" id="client_id" value={$client_info.id}>
    </form>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" align="center">
            ...
            <div class="col-md-12" style="margin-bottom: 20px;">
              ...
              <div class="col-md-12">
                <input name="appointment" type="date" placeholder="appointment" class="form-control" pattern="[0-9]{4}-[0-9]{2}-[0-9]{3}">
              </div>
            </div>
            <div class="col-md-12" style="margin-bottom: 20px;">
              <div class="col-md-12" align="left" style="padding-bottom: 10px;">
