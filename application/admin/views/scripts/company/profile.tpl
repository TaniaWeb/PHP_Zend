        ...
        <div class="main-content container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-11" style="padding-right:0px">
                <div class="row">
                  <div class="col-md-12">
                    <div class="col-md-4">
                      <div style="font-size:23px">{$company_info.fullname}</div>
                      <div>
                    ...
                    <div class="col-md-3 pull-right">
                      <div class="btn-group pull-right">
                        ...
                        <button id="btn_edit_company" onclick="editCompany(event, {$company_info.id})" class="btn btn-default" style="width:100px;">edit company</button>
                      </div>
                    </div>  
                  </div>
                </div>
                <div class="row" style="padding-top:10px">
                  <div class="col-md-12">
                    <div class="col-md-2">
                      ...
                      <div style="font-size:23px; padding-left:30px">{$company_info.user_count}</div>  
                    </div>
                    <div class="col-md-2" align="center" >
                      <div class="profile-item">Total Configurations</div>
                      <div style="font-size:23px;">{$company_info.points_count}</div>  
                    </div>
              ...
              <div class="col-md-12">
                <div class="row" >
                  <div class="col-md-2">
                    ...
                    <div style="font-size:15px">{$company_info.phone}</div>    
                  </div>
                  <div class="col-md-3">
                    <div class="profile-item">Email</div>
                    <div style="font-size:15px">{$company_info.email}</div>    
                  </div>
                  <div class="col-md-3">
                    <div class="profile-item">Website</div>
                    <div style="font-size:15px">{$company_info.website}</div>    
                  </div>
                  <div class="col-md-2">
                  ...
                  <div class="col-md-2" align="right">
                    ...
                    <div style="font-size:15px">{$company_info.date_last_saved}</div>    
                  </div>
                </div>  
                <div class="row" style="margin-top:13px">
                  <div class="col-md-2">
                    <div class="profile-item">Address</div>
                    <div style="font-size:15px">{$company_info.street} {$company_info.city}</div>
                  </div>
                  <div class="col-md-3">
                    <div class="profile-item">Frontend Language</div>
                    <div style="font-size:15px">
                      {if ($company_info.frontend_language=="AK")}
                        German
                      {else}
                        USA
                      {/if}
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align:right;">
                            <div class="btn-group">
                              <button id="btn_remove_user" onclick="removeUser({$user_info.id})" class="btn btn-default" style="width:70px;">remove</button>
                              <button id="btn_edit_user" onclick="editUser({$user_info.id})" class="btn btn-default" style="width:53px;">edit</button>
                            </div>
                          </td>
                        </tr>
                        {/foreach}
          ...
          <div class="container-fluid" style="padding:20px; padding-top:0px;">
            <div id="customerProfile_table_container" class="row" >
              ...
              <div class="col-md-3" onclick="loadBeauty('{$client_info.clientname}','{$client_info.userid}')">
                <div class="card">
                    <div class="image">
                    ...
                    <div class="content">
                        ...
                        <div class="meta">{$client_info.points_count} Konfigurationen</div>
      ...
      <div class="modal-dialog" >
        <div class="modal-content">
          ...
          <div align="center">
            ...
            <button type="button" onclick="addNewUser({$company_info.id})" class="btn btn-default add_new_user" style="width:150px;" >Add new User</button>
          </div>
